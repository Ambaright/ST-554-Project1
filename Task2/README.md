...
- Siona Benjamin
  + Change category variable name signifying if the sensor reading is low or high to something a little more descriptive to what the column is describing 
  + Add data type in function definitions
  + Consider comparing the ground truth measurements against sensor measurements 
  + Can use seaborn (or other python module) to quickly plot benzene vs other numeric variable to determine trends
